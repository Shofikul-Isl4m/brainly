...
const Credentials = () => {
  ...
  return (
    <div className="h-screen w-screen flex justify-center items-center">
      {/* <h1 className="absolute top-5 sm:top-10 border rounded-lg px-2 py-1">
        Demo Username: thearnabsaha , Password: Arnab@123{" "}
      </h1> */}
